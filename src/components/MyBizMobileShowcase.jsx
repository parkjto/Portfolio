...
import '../styles/MyBizMobileShowcase.css';
...
const MyBizMobileShowcase = () => {
  ...
  return (
    <section id="mybiz-mobile-showcase" className="mobile-showcase-container">
...
export default MyBizMobileShowcase;
