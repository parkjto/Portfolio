...
const MyBizFlowChart = () => {
  ...
  return (
    <section id="mybiz-flowchart" className="flowchart-container">
      <div className="flowchart-wrapper">
        ...
        <main className="flowchart-main">
          <header className="flowchart-header">
            <div className="header-label">FLOW CHART</div>
          ...
          <section className="flowchart-section">
            <h3 className="section-title">1. 핵심 기능 플로우</h3>
          ...
          {/* 섹션 2: 자동화 파이프라인 */}
          <section className="flowchart-section">
            <h3 className="section-title">2. 자동화 파이프라인</h3>
            <p className="section-description">
            ...
            <div className="info-box">
              <h4 className="info-title">핵심 가치</h4>
